...
class Solution implements SimplexSolutionInterface
{
    ...
    public function __construct(FractionsCollection $pointCoordinates, MFraction $value, SimplexTableCollection $simplexTables)
    {
    ...
    #[Override] public function getSolutionValue(): MFraction
    {
        return $this->value;
    }
