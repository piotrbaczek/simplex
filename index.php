...
<body>
	...
	<div id="content">
						...
						<div class="right" style="width: 49%;">
							<form id="solvethisform">
								...
								<textarea rows="10" name="textarea" id="textarea"
									style="width: 100%; resize: none;">2x1+5x2&lt;=30					2x1+3x2&lt;=26					0x1+3x2&lt;=15</textarea>
		...
		<?php }else{activity::errormessage('Strona została wyłączona przez administratora.<br/>Prosimy spróbować później.<br/>Powodzenia na egzaminie!');}?>
		<div id="footer">
			<a href="mailto:pgolasz@gmail.com">Piotr Gołasz</a> &copy; 2012 <a
